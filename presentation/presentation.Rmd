...
Slopes:
Single variable: `r tidy(games_play_fit)$estimate[2], 3`
Double variable: `r tidy(games_play_all_fit)$estimate[2], 3`

--

RMSE:
Single variable: train: `r rmse(games_play_pred, average_rating, .pred))$estimate[1], 3`
                  test: `r collect_metrics(games_play_fit_rs)$mean[1], 3`
Double variable: train: `r rmse(games_play_all_pred, average_rating, .pred))$estimate[1], 3`
                  test: `r collect_metrics(games_play_all_fit_rs)$mean[1], 3`
                  
--

Adjusted R Squared:
Single variable: `r glance(games_play_fit %>% pull_workflow_fit())$adj.r.squared[1], 3`
Double variable: `r glance(games_play_all_fit %>% pull_workflow_fit())$adj.r.squared[1], 3`
---
