...
We explore how different variables (category, average and minimum playing time, year publishe, and number of ratings) affect the average rating of a board game on BoardGameGeek.com. In particular, we attempt to predict the average rating of a board game from these variables. 
...
Our presentation slides can be found [here](https://github.com/ids-s1-20/project-too_legit_to_overfit/blob/main/presentation/presentation.html) and our presentation video [here](https://media.ed.ac.uk/media/IDS+Project+Presentation+-+too+legit+to+overfit/1_040ko2d8)
